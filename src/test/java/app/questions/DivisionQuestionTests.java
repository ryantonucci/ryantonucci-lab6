...
public class DivisionQuestionTests {

//    @Test
//    public void getPrompt() {
//        Question q = new DivisionQuestion(TestUtils.mockRandom(new int[] { 3, 2 }));
//        String prompt = q.getPrompt();
//        assertEquals("What is 6 ÷ 2? ", prompt, "getPrompt must return the question prompt");
//    }
//
//    @Test
//    public void getValidityMessage() {
//        Question q = new DivisionQuestion(TestUtils.mockRandom());
