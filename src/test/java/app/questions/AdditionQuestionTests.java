...
public class AdditionQuestionTests {

//    @Test
//    public void getPrompt() {
//        Question q = new AdditionQuestion(TestUtils.mockRandom(new int[] { 3, 2 }));
...
//        Question q = new AdditionQuestion(TestUtils.mockRandom());
...
//        Question q = new AdditionQuestion(TestUtils.mockRandom(new int[] { 1, 2 }));
//
